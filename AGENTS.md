...
|-------|---------|---------|
| **core** | Infrastructure (no feature deps) | See [`src/core/AGENTS.md`](src/core/AGENTS.md) |
| **features/chat** | Main sidebar interface | See [`src/features/chat/AGENTS.md`](src/features/chat/AGENTS.md) |
...
| **style** | Modular CSS | See [`src/style/AGENTS.md`](src/style/AGENTS.md) |
